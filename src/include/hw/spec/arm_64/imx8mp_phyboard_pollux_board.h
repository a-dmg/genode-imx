/*
 * \brief  Board definitions for i.MX8 MP phyboard pollux
 * \author Alice Domage
 * \date   2025-02-02
 */
...
#ifndef _SRC__INCLUDE__HW__SPEC__ARM_64__IMX8MP_PHYBOARD_POLLUX__BOARD_H_
#define _SRC__INCLUDE__HW__SPEC__ARM_64__IMX8MP_PHYBOARD_POLLUX__BOARD_H_

#include <hw/spec/arm/boot_info.h>
#include <hw/spec/arm/imx_uart.h>

namespace Hw::Imx8mp_phyboard_pollux_board {
...
#endif /* _SRC__INCLUDE__HW__SPEC__ARM_64__IMX8MP_PHYBOARD_POLLUX__BOARD_H_ */
